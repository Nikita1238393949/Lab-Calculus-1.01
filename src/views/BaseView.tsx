                ...
                <Row gutter={[17, 24]} style={{margin: "50px"}}>
                    <Col xs={24} lg={13} xxl={12}>
                        ...
                        <Card style={{marginTop: "17px"}}>
                            ...
                            <ol>
                                <li>
                                    Построить графики <InlineMath math={"f(x)"}/> и ступенчатые фигуры,соответсвующие
                                    суммам
                                    Дарбу для некоторых значений <InlineMath math={'n'}/>. Добавить их значения в
                                    таблицу в
                                    отчете. (см. Замечания)
                                </li>
                                <li>
                            ...
                            <ol>
                                <li>
                                    Входные данные программы: число точек,разбиения,способ выбора оснащения (левые,
                                    правые,
                                    средние, случайные).
                                </li>
                                <li>
