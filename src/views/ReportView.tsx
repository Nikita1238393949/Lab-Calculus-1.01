    ...
    <StyledRow gutter={16}>
      <Col span={12}>
        ...
        <Typography.Text>
          ...
          аналитического вычисления и численного анализа, включая визуализацию и
        ...
        <Row>
          <Col span={11}>
            ...
            <br /> <br />
            <InlineMath
              math={"\\large U(f, P) = \\sum_{i=1}^{n} f(x_i) \\cdot \\Delta x"}
            />
          </Col>
      ...
      <VerticalDivider type={"vertical"} />
      <Col span={11}>
        <Typography.Title level={3}>4. Результаты</Typography.Title>
        ...
        <ol>
          <Typography.Text>
            ...
            <li>
              ...
              результатом, вычисленным по формуле Ньютона-Лейбница, подтверждая
        ...
        <ol>
          <Typography.Text>
            ...
            <li>
              Были построены и сравнены графики интегральных сумм для разных n с
              использованием случайных оснащений, что показало влияние выбора
              точек на точность приближения.
            </li>
          </Typography.Text>
        </ol>
        <Divider />
